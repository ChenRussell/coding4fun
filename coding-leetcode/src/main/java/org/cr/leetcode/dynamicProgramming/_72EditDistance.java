...
public class _72EditDistance {
     ...
     *
     * Note that the problem is symmetric. The insert operation in one direction (i.e. from word1 to word2) is same as delete operation in other.
    ...
    public static void main(String[] args) {
        _72EditDistance editDistance = new _72EditDistance();
        int res = editDistance.minDistance("c", "ru");
